...
# print("Yes" or "No")
# I would expect both to output 'all systems go'. 
# Alhough I could see the == in the first one maybe causing an error, as it might need a parentheses like and(computer_status_code == 200) and space_suits_on
